...
`,
  ...
  {
    slug: 'oakland-grief-losing-your-baseball-team',
    title: 'Oakland Grief: What It Really Feels Like to Lose Your Baseball Team',
    excerpt: 'Talking to Oakland fans about identity, loss, and whether they will ever follow the A\'s again.',
    category: 'Oakland',
    date: '2026-01-20',
...
`,
  ...
  {
    slug: 'sacramento-pit-stop-inside-athletics-temp-home',
    title: 'The Sacramento Pit Stop: Inside the A\'s Temporary Home at Sutter Health Park',
    excerpt: 'A Triple-A stadium hosting a big league team. What players, fans, and the city actually think about the arrangement.',
    category: 'Sacramento',
    date: '2026-02-01',
...
`,
  ...
  {
    slug: 'las-vegas-athletics-trademark-battle',
    title: 'The Las Vegas Athletics Trademark Battle: What Happened and What It Means',
    excerpt: 'The USPTO denied the A\'s trademark for Las Vegas Athletics. The full story of a legal dispute that revealed real complications in the team\'s new identity.',
    category: 'Las Vegas',
    date: '2026-01-10',
    readingTime: '9 min read',
    content: `
When a professional sports franchise relocates, one of the first items on the administrative checklist is securing the new name and branding through the United States Patent and Trademark Office. It is routine. The Las Vegas Raiders, the Vegas Golden Knights, the Las Vegas Aces -- all of them navigated the trademark process without significant difficulty. The Athletics expected to do the same.

They did not.

**The Denial**

In early 2025, the USPTO issued an office action -- effectively a preliminary denial -- on the Athletics' application to trademark "Las Vegas Athletics." The examiner's rejection cited multiple grounds, and the dispute became public in a way the team had not anticipated.

The primary objection was a likelihood-of-confusion finding. The examiner identified existing trademarks that, under the USPTO's analysis, were sufficiently similar to "Las Vegas Athletics" in relevant commercial categories to create potential consumer confusion. The issue was not with "Las Vegas" as a geographic descriptor but with "Athletics" as a term, particularly when combined with the specific trade dress -- the green-and-gold color scheme, the elephant logo elements -- that the A's had used for decades.

A secondary objection involved the descriptiveness doctrine. "Athletics" as a standalone term can be considered merely descriptive of sports activities, which makes it difficult to trademark without demonstrating what lawyers call "acquired distinctiveness" or secondary meaning. The A's have argued that their use of "Athletics" as a franchise name has been sufficiently distinctive and longstanding to establish that secondary meaning, but the examiner was not immediately persuaded.

**The Complications**

The practical effect of the denial was immediate. Without a registered trademark for "Las Vegas Athletics," the team faced complications in licensing merchandise, protecting their branding against unauthorized use, and in some cases in executing commercial agreements that required confirmed trademark rights.

Merchandise in the Las Vegas market moved forward under the existing "Athletics" trademark that the organization holds from its Oakland registration, but this created ambiguity. Products that prominently featured "Las Vegas" in combination with "Athletics" existed in a legal gray zone that made some retail partners cautious.

The team's legal team filed a response to the office action, as is standard in trademark disputes. The response offered evidence of the term's acquired distinctiveness through the franchise's 120-plus-year history, presented arguments distinguishing the existing conflicting marks, and requested reconsideration.

As of early 2026, the dispute remains unresolved. The USPTO process allows for multiple rounds of response and rejection before either a final refusal or approval is issued. The case may ultimately be appealed to the Trademark Trial and Appeal Board if the examiner maintains the denial.

**The Strategic Dimension**

Beyond the legal mechanics, the trademark dispute has carried strategic and symbolic weight. When it became public in late 2025, Oakland fans celebrated on social media with a fervor that was equal parts genuine amusement and bitter satisfaction. From their perspective, the universe was declining to simply hand the relocated franchise a clean new identity.

Other observers noted the irony that the team spent years failing to build a ballpark in Oakland partly over naming-rights and financial structure disputes, and was now encountering naming difficulties in its new home through a different legal mechanism entirely.

Several trademark attorneys who follow sports law commented publicly that the situation, while unusual, was not without precedent. The name "Athletics" occupies a genuinely complicated position in trademark law because it has dual existence as both a longstanding specific franchise identity and as a generic descriptor for sports. Resolving that tension required more careful legal work than the team apparently anticipated.

**What Resolution Looks Like**

The most likely outcome, according to sports trademark specialists, is a negotiated resolution in which the A's either obtain the trademark with restrictions or conditions, make minor modifications to the branding that resolve the likelihood-of-confusion issue, or pursue a licensing arrangement with any conflicting mark holders.

The worst-case scenario -- a sustained final refusal that prevents the team from registering the Las Vegas Athletics name -- would be commercially significant but not necessarily fatal to the franchise's operations. Teams do operate under unregistered marks, relying on common-law trademark rights that accrue from actual use in commerce. But the protection is weaker, the enforcement is more expensive, and the uncertainty creates real business complications.

The Athletics' legal team has indicated they expect to resolve the matter before the Las Vegas stadium opens in 2028. The timeline allows for multiple rounds of USPTO proceedings and, if necessary, appeals. From a purely practical standpoint, the team has time.

But the story of the trademark dispute has attached itself to the broader Las Vegas narrative in ways that are not entirely about intellectual property. It has become, for critics of the relocation, another piece of evidence that the move was rushed and poorly planned. For supporters, it is a bureaucratic footnote that will be forgotten once the team is playing in their new building.

Both interpretations contain truth. The trademark dispute is real and unresolved and matters commercially. It is also a bounded legal process that will, eventually, produce an outcome one way or another. What it has revealed most clearly is that building a new identity for a franchise with 120 years of history in one city is more complicated than it might appear from the outside -- and that the government agency responsible for protecting trademarks is not going to simply wave through the paperwork.

Whether that turns out to be a minor inconvenience or a meaningful complication for the Las Vegas Athletics -- or whatever they end up being called -- remains to be seen.
`,
  },
  {
    slug: 'how-las-vegas-stadium-got-built',
    title: 'How the Las Vegas A\'s Stadium Got Built: The Politics, the Money, and the Deal',
    excerpt: 'The $380 million Nevada public funding deal, the opposition, the politics, and how a ballpark on the Strip got approved.',
    category: 'Las Vegas',
    date: '2025-12-15',
    readingTime: '12 min read',
    content: `
...
`,
  ...
  {
    slug: 'history-athletics-franchise-philadelphia-to-vegas',
    title: 'From Philadelphia to Las Vegas: The Complete History of the Most-Moved Franchise in MLB',
    excerpt: 'Connie Mack\'s dynasty, Kansas City, Oakland\'s dynasty, and now Las Vegas. No franchise in baseball has moved more often.',
    category: 'History',
    date: '2025-11-20',
...
`,
  ...
  {
    slug: 'oakland-fans-who-will-never-forgive',
    title: 'The Oakland Fans Who Will Never Forgive',
    excerpt: 'Profiles of fans who are done with the team for good. Their stories and why they feel that way.',
    category: 'Oakland',
    date: '2026-01-05',
    readingTime: '11 min read',
    content: `
...
`,
  ...
  {
    slug: 'what-as-move-means-for-mlb',
    title: 'What the A\'s Move Means for Major League Baseball',
    excerpt: 'The first MLB relocation since 2005 signals something about small markets, stadium economics, and the future of baseball geography.',
    category: 'MLB',
    date: '2025-10-15',
    readingTime: '12 min read',
    content: `
...
`,
  ...
  {
    slug: 'rise-and-fall-oakland-coliseum',
    title: 'Rise and Fall: The Oakland Coliseum and What It Became',
    excerpt: 'From one of baseball\'s finest venues to its worst. How a stadium\'s decline mirrored a franchise\'s decline.',
    category: 'Oakland',
    date: '2025-12-01',
    readingTime: '11 min read',
    content: `
...
`,
  ...
  {
    slug: 'who-is-really-to-blame-as-leaving-oakland',
    title: 'Who Is Really to Blame for the A\'s Leaving Oakland',
    excerpt: 'Assigning responsibility: John Fisher, the city of Oakland, the fans, MLB, the media. An honest accounting.',
    category: 'Analysis',
    date: '2025-09-20',
...
`,
  ...
  {
    slug: 'oakland-as-fan-guide-grief-moving-on',
    title: 'For Oakland Fans Still Processing: A Guide to the Stages of Losing Your Team',
    excerpt: 'The loss is real. Here is what other fans have experienced and what actually helps.',
    category: 'Oakland',
    date: '2026-02-20',
...
`,
  ...
  {
    slug: 'john-fisher-most-hated-owner-baseball',
    title: 'How John Fisher Became the Most Despised Owner in Professional Sports',
    excerpt: 'From anonymous billionaire to the public face of franchise abandonment. The arc of baseball\'s most controversial ownership.',
    category: 'Analysis',
    date: '2025-11-05',
    readingTime: '13 min read',
    content: `
Before the A's relocation became a national news story, most people outside the Bay Area had never heard of John Fisher. He was among the more anonymous major sports franchise owners in the country -- the inheritor of a significant retail fortune, a Yale graduate, an heir to the Gap clothing empire built by his parents Donald and Doris Fisher. He did not seek publicity. He did not give many interviews. He was not known for the kind of theatrical ownership behavior that attracts media attention.

By 2024, Fisher had become, in the view of a substantial portion of the baseball-watching public, the worst owner in professional sports. That transformation -- from anonymous to widely despised -- is a story about the choices of one individual, the ecosystem that enabled those choices, and the way a drawn-out civic betrayal can produce a specific and durable kind of public contempt.

**The Early Years**

Fisher became the principal owner of the A's in 2005, partnering with Lew Wolff on the purchase. The deal valued the franchise at approximately $180 million, which looks like extraordinary value given that the franchise is now worth somewhere north of $1 billion by Forbes estimates.

The early Fisher years were not obviously catastrophic. The team under Billy Beane continued to field competitive rosters through the Moneyball approach, making playoff runs in 2006 and then again in the early 2010s. Fisher was not especially visible in those years. Beane and Wolff served as the public faces of the franchise.

The low-payroll approach that would become Fisher's defining characteristic was present from the beginning, but in the early years it produced enough wins to be defensible. The argument that a small-revenue franchise could compete through smart roster construction had genuine empirical support from the Moneyball era.

Where the defensibility eroded was in the stadium question. Fisher, from early in his ownership, made clear that a new ballpark was his condition for long-term commitment to the Oakland market. He spent significant resources exploring San Jose as an alternative. When that path was blocked by the Giants' territorial rights, and when Howard Terminal became the focus of the final push, Fisher's willingness to actually fund the project himself was consistently minimal.

**The Payroll Problem**

The numbers tell a straightforward story. During Fisher's ownership, the A's payroll ranked in the bottom three of MLB's thirty franchises for the majority of seasons. In several years they had the lowest payroll in the sport. In 2023, the year Fisher announced the Las Vegas move, the A's Opening Day payroll was approximately $57 million. The MLB average was around $140 million. The Yankees and Mets were each over $250 million.

The low payroll was not a product of limited resources. Fisher's net worth has been estimated by Forbes at approximately $2.6 billion. He is one of the wealthier owners in professional sports. The decision to operate the A's with a minimal payroll was a choice, consistently made over nearly two decades.

The standard defense of the approach -- that the A's were building through the draft and developing young talent, that big free-agent contracts are inefficient uses of capital -- contains elements of truth but does not fully account for what was actually happening. Teams can use analytics and development to be smart about player acquisition without being the lowest-spending franchise in the sport. The relationship between payroll and competitiveness is not linear, but at the extremes Fisher was operating in, there is a consistent correlation between investment and outcomes.

Oakland fans watched consecutive years of deliberately assembled mediocre rosters and were told the approach was actually sophisticated. They eventually stopped believing it.

**The Relocation Process**

How Fisher handled the relocation announcement is where the public narrative solidified against him.

The September 28, 2023, announcement that the team would leave Oakland was made without the kind of community engagement, acknowledgment of history, or expression of regret that might have softened the reaction. Fisher did not hold a press conference in Oakland. He did not meet with community leaders or season-ticket holders before the announcement. There was no farewell tour, no acknowledgment in the announcement itself that this was a loss for the city.

The comment that attracted the most sustained anger came in media interactions around the relocation announcement, when Fisher suggested that Oakland's fans had not shown sufficient support for the franchise. To Oakland fans who had watched Fisher systematically underspend on the roster for years and then blame the resulting poor attendance on their insufficient loyalty, this was not merely incorrect -- it was an insult.

The final game at the Coliseum was not organized with any formal farewell ceremony by the franchise. The postgame acknowledgment was minimal. The organization's apparent approach was to have the last game be as unremarkable as possible. The fans in attendance created their own ceremony, staying long after the game ended, staging tributes to the ballpark and the franchise that the organization itself did not provide.

**The National Reaction**

By the time the relocation was complete, Fisher had achieved a kind of negative celebrity that he had conspicuously avoided during his years of quiet ownership. Baseball media wrote extensively about the contrast between his wealth and his investment in the team. Features traced the history of ownership decisions that had contributed to the departure. Social media, where Oakland fans had long organized under slogans including "Sell the Team" directed at Fisher, amplified the criticism to audiences that had previously been unaware of the situation.

The ESPN documentary treatment of the Oakland sports departures, the various longform features in major publications, and the coverage of the Sacramento arrangement all centered Fisher as the agent of the departure in ways that were essentially accurate.

What emerged was a portrait of an ownership approach that treated a franchise as a financial instrument rather than as a community institution. In this reading, Fisher bought a franchise at below-market value in 2005, operated it with minimal investment to generate positive cash flow, and exited the Oakland market when the stadium economics no longer worked in his favor -- leaving behind a community that had invested decades of loyalty and civic identity in the team.

Whether that portrait is fully fair depends on how you weigh the legitimacy of the Oakland stadium impasse and the degree to which the city's failures contributed to the outcome. But even giving Fisher full credit for the honest obstacles he faced in Oakland, the pattern of minimal investment in the playing product over twenty years is difficult to defend.

**The Las Vegas Future**

Fisher remains the owner of the Las Vegas franchise. Whether the Las Vegas era will be different -- whether the new market, the new stadium, and the implicit pressure to prove the move was justified will produce a different ownership approach -- is genuinely unknowable.

Several sports business analysts have noted that the Las Vegas market will require a different investment posture than Oakland. The city has no existing fan base to draw on; building one requires winning, which requires spending. The economic model of entertainment-market baseball may actually create incentives for investment that the Oakland market did not.

Others note that Fisher's ownership patterns over twenty years have not changed in response to changing circumstances, and that there is no particular reason to expect Las Vegas to produce a different version of the same owner.

What is certain is that Fisher's reputation, built over decades of quiet anonymity, is now permanently associated with one of the most notable franchise departures in American professional sports. The circumstances of his ownership -- the low payrolls, the failed stadium negotiations, the departure announcement, the minimal farewell -- have been documented extensively and will follow the franchise in Las Vegas the way Finley's behavior followed the A's out of Oakland and out of Kansas City.

Legacies in professional sports ownership are made from the biggest decisions. Fisher's biggest decision was to leave Oakland. How Las Vegas judges the decision that brought them a franchise depends on what that franchise does next.
`,
  },
  {
    slug: 'as-farm-system-building-for-vegas',
    title: 'Building for Vegas: Inside the A\'s Farm System',
    excerpt: 'While everything else was chaos, the A\'s player development operation has been quietly building something. Who is coming for the Las Vegas era?',
    category: 'Baseball',
    date: '2026-01-25',
    readingTime: '11 min read',
    content: `
...
`,
  ...
  {
    slug: 'how-las-vegas-became-sports-town',
    title: 'How Las Vegas Became a Real Sports City',
    excerpt: 'The Golden Knights changed everything. Then the Raiders. Now the A\'s. How the entertainment capital of the world became a legitimate sports market.',
    category: 'Las Vegas',
    date: '2025-10-01',
    readingTime: '12 min read',
    content: `
...
`,
  ...
  {
    slug: 'sacramento-mlb-expansion-dream',
    title: 'Sacramento\'s Expansion Dream: Can the City Finally Get Its MLB Team?',
    excerpt: 'With the A\'s leaving, Sacramento is once again dreaming of an expansion team. The history of those efforts and how realistic it actually is.',
    category: 'Sacramento',
    date: '2026-03-01',
    readingTime: '11 min read',
    content: `
